...
- Name: a11y.spec.ts >> accessibility of the composed pages >> /docs/charts has no axe violations
...
Error: 
  [critical] aria-valid-attr-value: ARIA attributes must conform to valid values
    <button type="button" role="tab" id="_R_jklubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="_R_
  [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds
    <span class="vk-sidebar__label">All charts</span>
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e35]:
        ...
        - article [ref=e513]:
          - generic [ref=e514]:
            - heading "Charts" [level=1] [ref=e515]
            - paragraph [ref=e516]: 6 chart types in pure inline SVG. No d3, no canvas library, no charting dependency — 8.14 kB for all of them.
          - generic [ref=e517]:
            - heading "Import" [level=2] [ref=e518]
            - paragraph [ref=e519]: Charts live at their own subpath, with their own stylesheet, so an app that never draws a chart pays nothing for them.
            - generic [ref=e520]:
              - generic [ref=e521]:
                - tablist [ref=e523]:
                  - tab "TS" [selected] [ref=e524] [cursor=pointer]
                  - tab "JS" [ref=e525] [cursor=pointer]
                - generic [ref=e526]:
