...
[docs/ARCHITECTURE.md](docs/ARCHITECTURE.md) — see §12 for the roadmap.

## Contributing

See [CONTRIBUTING.md](CONTRIBUTING.md). Issues and component requests are welcome; requests with
traction jump the queue between tiers.

## License

[MIT](LICENSE) © 2026 Vivek Kumar Singh
