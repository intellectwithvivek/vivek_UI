...
export const FAQ_ENTRIES: FaqEntry[] = [
  {
    ...
    answer:
      'VivekUI is a free, MIT-licensed React component library with 95 accessible components and 10 SVG charts. It has zero runtime dependencies: React and React DOM are peer dependencies, and everything else is written in-house. It is installed as @the_viveksingh/vivek-ui from npm.',
  },
  {
