...
| Server Components | 49 of 89 need no client boundary | Depends what you copied | Often needs a client boundary |
...
**89 components. 138 runtime exports.** Every one is covered by tests including
...
| Every one of the 89 components | **41.6 kB** |
...
**49 of the 89 components carry no `'use client'`** and render directly in React Server Components.
