...
| `styles.css` | 242.6 kB raw, **33.8 kB gzipped** |
| `charts.css` | 12.4 kB raw, **2.5 kB gzipped** |
| `a typical page (dist/css/*)` | 18.4 kB raw, **4.0 kB gzipped** |
<!-- size-table:end -->
