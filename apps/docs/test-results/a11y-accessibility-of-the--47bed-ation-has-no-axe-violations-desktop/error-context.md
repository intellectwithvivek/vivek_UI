...
Error: 
  [critical] aria-valid-attr-value: ARIA attributes must conform to valid values
    <button type="button" role="tab" id="_R_ir8lubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="_R
    <button type="button" role="tab" id="_R_jqlubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="_R_
    <button type="button" role="tab" id="_R_jslubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="_R_
  [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds
    <span class="vk-sidebar__label">Installation</span>
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e35]:
        ...
        - article [ref=e513]:
          - generic [ref=e514]:
            - heading "Installation" [level=1] [ref=e515]
            - paragraph [ref=e516]: Two steps. There is no third.
          - generic [ref=e517]:
            - heading "1. Install" [level=2] [ref=e518]
            - generic [ref=e519]:
              - tablist [ref=e520]:
                - tab "npm" [selected] [ref=e521] [cursor=pointer]
                - tab "pnpm" [ref=e522] [cursor=pointer]
                - tab "yarn" [ref=e523] [cursor=pointer]
                - tab "bun" [ref=e524] [cursor=pointer]
              - tabpanel "npm" [ref=e526]:
                - generic [ref=e527]:
                  - generic [ref=e528]:
                    - generic [ref=e529]: terminal
                    - generic [ref=e530]:
                      - button "Copy" [ref=e531] [cursor=pointer]
                      - status [ref=e532]
                  - code [ref=e534]: npm install @the_viveksingh/vivek-ui
            - paragraph [ref=e535]:
              ...
              - code [ref=e536]: npm ls --omit=dev @the_viveksingh/vivek-ui
              - text: .
          - generic [ref=e537]:
            - heading "2. Import the stylesheet once" [level=2] [ref=e538]
            - generic [ref=e539]:
              - tablist [ref=e540]:
                - tab "Next.js App Router" [selected] [ref=e541] [cursor=pointer]
                - tab "Next.js Pages Router" [ref=e542] [cursor=pointer]
                - tab "Vite / CRA" [ref=e543] [cursor=pointer]
              - tabpanel "Next.js App Router" [ref=e545]:
                - generic [ref=e546]:
                  - generic [ref=e547]:
                    - generic [ref=e548]: app/layout.tsx
                    - tablist [ref=e550]:
                      - tab "TS" [selected] [ref=e551] [cursor=pointer]
                      - tab "JS" [ref=e552] [cursor=pointer]
                    - generic [ref=e553]:
          ...
          - generic [ref=e558]:
            ...
            - generic [ref=e561]:
              - generic [ref=e562]:
                - tablist [ref=e564]:
                  - tab "TS" [selected] [ref=e565] [cursor=pointer]
                  - tab "JS" [ref=e566] [cursor=pointer]
                - generic [ref=e567]:
                  - button "Copy" [ref=e568] [cursor=pointer]
                  - status [ref=e569]
              - code [ref=e571]: "import { LineChart } from '@the_viveksingh/vivek-ui/charts' import '@the_viveksingh/vivek-ui/charts.css'"
          - generic [ref=e572]:
            - heading "Compound components in Server Components" [level=2] [ref=e573]
            - alert [ref=e574]:
              - generic [ref=e575]: "!"
              - generic [ref=e576]:
                - generic [ref=e577]: Use the named part exports on the server
                - paragraph [ref=e579]:
                  - text: Interactive compound components —
                  - code [ref=e580]: Tabs
                  - text: ","
                  - code [ref=e581]: Accordion
                  - text: ","
                  - code [ref=e582]: Modal
                  - text: ","
                  - code [ref=e583]: Drawer
                  - text: ","
                  - code [ref=e584]: Navbar
                  - text: ","
                  - code [ref=e585]: Sidebar
                  - text: — are client components. From a Server Component they arrive as a client reference, and
                  - code [ref=e586]: Tabs.List
                  - text: reads
                  - code [ref=e587]: undefined
                  - text: off it. Import
                  - code [ref=e588]: TabsList
            ...
            - generic [ref=e591]:
              - generic [ref=e592]:
                ...
                - generic [ref=e597]:
                  ...
                  - status [ref=e599]
              - code [ref=e601]: "// In a Server Component import { Tabs, TabsList, TabsTab } from '@the_viveksingh/vivek-ui' // In a client component, either works import { Tabs } from '@the_viveksingh/vivek-ui' <Tabs.List>...</Tabs.List>"
          - generic [ref=e602]:
            - heading "That is the whole setup" [level=2] [ref=e603]
            - status [ref=e604]:
              - paragraph [ref=e607]: No config file, no CLI, no Tailwind, no PostCSS plugin, no Babel plugin, and no required provider. If you needed a third step, that would be a bug in the library's design.
  - alert [ref=e608]
```
