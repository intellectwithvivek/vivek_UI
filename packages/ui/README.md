...
<!-- hero-stats:start -->
**100 accessible React components**, **10 SVG charts** and **12 ready-made pages** you can copy.
...
| Server Components | 49 of 100 need no client boundary | Depends what you copied | Often needs a client boundary |
...
**100 components. 157 runtime exports.** Every one is covered by tests including
...
| Every component, imported at once | **53.5 kB** |
| `styles.css` | 211.8 kB raw, **29.3 kB gzipped** |
...
**49 of the 100 components carry no `'use client'`** and render directly in React Server Components.
...
that all 64 client files still carry theirs in **both** the ESM and CJS output.
