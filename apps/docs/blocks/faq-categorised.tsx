import { Container, FAQ, Section } from '@the_viveksingh/vivek-ui'
...
export default function FaqCategorised() {
  return (
    <Section>
      <Container>
        <Section.Header eyebrow="Help centre" title="Answers by topic" align="center" />
      </Container>
      <FAQ
        padding="sm"
