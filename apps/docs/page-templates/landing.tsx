...
const PLANS = [
  {
    ...
    features: ['All 106 components', 'All 10 charts', 'Full source on GitHub', 'MIT licence'],
    cta: (
  ...
  return (
    <>
      ...
      <Hero
        ...
        description="One hundred and six components and ten charts, with no runtime dependencies, no CSS-in-JS, and no build plugin. Install one package and import a stylesheet."
