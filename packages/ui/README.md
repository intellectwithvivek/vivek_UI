...
<!-- hero-stats:start -->
**99 accessible React components**, **10 SVG charts** and **12 ready-made pages** you can copy.
...
| Server Components | 49 of 99 need no client boundary | Depends what you copied | Often needs a client boundary |
...
**99 components. 151 runtime exports.** Every one is covered by tests including
...
| Every component, imported at once | **52.5 kB** |
| `styles.css` | 209.7 kB raw, **29.2 kB gzipped** |
...
**49 of the 99 components carry no `'use client'`** and render directly in React Server Components.
...
that all 63 client files still carry theirs in **both** the ESM and CJS output.
