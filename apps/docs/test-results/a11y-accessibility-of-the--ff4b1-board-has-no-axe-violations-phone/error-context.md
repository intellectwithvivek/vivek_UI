    ...
    - generic [ref=e19]:
      - navigation "Breadcrumb" [ref=e20]:
        - list [ref=e21]:
          ...
          - listitem [ref=e24]
          - listitem [ref=e27]:
            - link "Page templates" [ref=e28] [cursor=pointer]:
              - /url: /pages
          - listitem [ref=e29]
          - listitem [ref=e32]:
            - generic [ref=e33]: App dashboard
      - generic [ref=e34]:
        - paragraph [ref=e35]: Application
        - heading "App dashboard" [level=1] [ref=e36]
        - paragraph [ref=e37]: A collapsible sidebar, KPI cards, an accessible chart, and a table that sorts, searches and paginates. Free and MIT licensed.
        - generic [ref=e38]:
          - generic [ref=e39]: 13 components
          - generic [ref=e40]: 325 lines
          - generic "Declares 'use client'" [ref=e41]: Client component
          - link "Source on GitHub" [ref=e42] [cursor=pointer]:
            - /url: https://github.com/intellectwithvivek/vivek_UI/blob/main/apps/docs/page-templates/dashboard.tsx
      - paragraph [ref=e44]: The shell every internal tool starts from. The sidebar collapses to an icon rail, the table sorts and searches and paginates without a data library, and the chart ships an accessible data table alongside the SVG so the figures are readable by something other than an eye.
      - generic [ref=e45]:
        - heading "Live demo" [level=2] [ref=e46]
        - generic [ref=e47]:
          - generic [ref=e48]:
            - group "Preview width" [ref=e49]:
              - generic [ref=e50]:
                - button "Phone" [ref=e51] [cursor=pointer]
                - button "Tablet" [ref=e52] [cursor=pointer]
                - button "Desktop" [pressed] [ref=e53] [cursor=pointer]
            - paragraph [ref=e54]: Full width · the frame has its own viewport, so the breakpoints are real
          - iframe [ref=e56]:
            - generic [ref=f1e2]:
                    ...
                    - generic [ref=f1e206]:
                      ...
                      - navigation "Pagination" [ref=f1e208]:
                        ...
                        - button "Next page" [ref=f1e212] [cursor=pointer]:
                          - generic [ref=f1e213]: ›
      - generic [ref=e57]:
        - heading "What it uses" [level=2] [ref=e58]
        - paragraph [ref=e59]: "Every one of these is an export of the published package. Nothing on this page is hand-rolled, which is the point of the gallery: if a page needed something the library does not have, the library would be missing a component."
        - generic [ref=e60]:
          - link "Badge" [ref=e61] [cursor=pointer]:
            - /url: /docs/components/badge
          - link "Button" [ref=e62] [cursor=pointer]:
            - /url: /docs/components/button
          - link "Card" [ref=e63] [cursor=pointer]:
            - /url: /docs/components/card
          - link "DataTable" [ref=e64] [cursor=pointer]:
            - /url: /docs/components/data-table
          - link "Grid" [ref=e65] [cursor=pointer]:
            - /url: /docs/components/grid
          - link "Heading" [ref=e66] [cursor=pointer]:
            - /url: /docs/components/heading
          - link "Sidebar" [ref=e67] [cursor=pointer]:
            - /url: /docs/components/sidebar
          - link "SidebarItem" [ref=e68] [cursor=pointer]:
            - /url: /docs/components/sidebar
          - link "SidebarSection" [ref=e69] [cursor=pointer]:
            - /url: /docs/components/sidebar
          - link "SidebarToggle" [ref=e70] [cursor=pointer]:
            - /url: /docs/components/sidebar
          - link "Stack" [ref=e71] [cursor=pointer]:
            - /url: /docs/components/stack
          - link "Text" [ref=e72] [cursor=pointer]:
            - /url: /docs/components/text
          - link "AreaChart" [ref=e73] [cursor=pointer]:
            - /url: /docs/charts/area-chart
      - generic [ref=e74]:
        - heading "Imports" [level=2] [ref=e75]
        - generic [ref=e76]:
          - generic [ref=e77]:
            - radiogroup "Code language" [ref=e78]:
              - radio "TS" [checked] [ref=e80] [cursor=pointer]
              - radio "JS" [ref=e82] [cursor=pointer]
            - generic [ref=e84]:
              - button "Copy" [ref=e85] [cursor=pointer]
              - status [ref=e86]
          - code [ref=e88]: "import { Badge, Button, Card, DataTable, Grid, Heading, Sidebar, SidebarItem, SidebarSection, SidebarToggle, Stack, Text } from '@the_viveksingh/vivek-ui' import { AreaChart } from '@the_viveksingh/vivek-ui/charts'"
      - generic [ref=e89]:
        - heading "The whole page" [level=2] [ref=e90]
        - paragraph [ref=e91]:
