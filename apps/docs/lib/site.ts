...
export const SITE_TAGLINE =
  'VivekUI is a free, MIT-licensed React component library with 106 accessible components and 10 SVG charts, and zero runtime dependencies.'

export const SITE_DESCRIPTION =
  'A free React component library with zero dependencies: 106 accessible, server-safe components and 10 SVG charts. One install, one CSS import, no Tailwind. MIT.'
