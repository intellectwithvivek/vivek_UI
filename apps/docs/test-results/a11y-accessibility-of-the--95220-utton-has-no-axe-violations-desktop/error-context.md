...
- Name: a11y.spec.ts >> accessibility of the composed pages >> /docs/components/button has no axe violations
...
Error: 
  [critical] aria-valid-attr-value: ARIA attributes must conform to valid values
    ...
    <button type="button" role="tab" id="_R_9gkav5ubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="
    <button type="button" role="tab" id="_R_9h4av5ubt9ftb_-tab-ts" class="vk-tabs__tab" aria-selected="true" aria-controls="
  [serious] color-contrast: Elements must meet minimum color contrast ratio thresholds
    <span class="vk-sidebar__label">Button</span>
  ...
  - main [ref=e30]:
    - generic [ref=e31]:
      ...
      - generic [ref=e35]:
        ...
        - article [ref=e513]:
          - generic [ref=e514]:
            - paragraph [ref=e515]: Actions
            - heading "Button" [level=1] [ref=e516]
            - paragraph [ref=e517]: A button.
            - generic [ref=e518]:
              - generic "Renders in a Server Component" [ref=e519]: Server safe
          ...
          - generic [ref=e534]:
            ...
            - generic [ref=e543]:
              - generic [ref=e544]:
                - tablist [ref=e546]:
                  - tab "TS" [selected] [ref=e547] [cursor=pointer]
                  - tab "JS" [ref=e548] [cursor=pointer]
                - generic [ref=e549]:
                  - button "Copy" [ref=e550] [cursor=pointer]
                  - status [ref=e551]
              - code [ref=e553]: <Button>Solid</Button> <Button variant="outline">Outline</Button> <Button variant="ghost">Ghost</Button> <Button variant="link">Link</Button>
          - generic [ref=e554]:
            - heading "Sizes and full width" [level=2] [ref=e555]
            - generic [ref=e557]:
              - generic [ref=e558]:
                - button "Small" [ref=e559] [cursor=pointer]
                - button "Medium" [ref=e560] [cursor=pointer]
                - button "Large" [ref=e561] [cursor=pointer]
              - button "Full width" [ref=e562] [cursor=pointer]
            - generic [ref=e563]:
              - generic [ref=e564]:
                - tablist [ref=e566]:
                  - tab "TS" [selected] [ref=e567] [cursor=pointer]
                  - tab "JS" [ref=e568] [cursor=pointer]
                - generic [ref=e569]:
                  - button "Copy" [ref=e570] [cursor=pointer]
                  - status [ref=e571]
              - code [ref=e573]: <Button size="sm">Small</Button> <Button size="md">Medium</Button> <Button size="lg">Large</Button> <Button fullWidth>Full width</Button>
          - generic [ref=e574]:
            - heading "Loading" [level=2] [ref=e575]
            - paragraph [ref=e576]: loading also disables the button, so a submit cannot fire twice while a request is in flight.
            - generic [ref=e578]:
              - button "Saving changes" [disabled] [ref=e579]
              - button "Loading" [disabled] [ref=e581]
              - button "Disabled" [disabled] [ref=e583]
            - generic [ref=e584]:
              - generic [ref=e585]:
                - tablist [ref=e587]:
                  - tab "TS" [selected] [ref=e588] [cursor=pointer]
                  - tab "JS" [ref=e589] [cursor=pointer]
                - generic [ref=e590]:
                  - button "Copy" [ref=e591] [cursor=pointer]
                  - status [ref=e592]
              - code [ref=e594]: <Button loading>Saving changes</Button> <Button loading variant="outline">Loading</Button> <Button disabled>Disabled</Button>
          - generic [ref=e595]:
            - heading "As a link" [level=2] [ref=e596]
            - paragraph [ref=e597]: asChild renders your element instead of a <button>. A link that looks like a button must be an anchor — otherwise middle-click, cmd-click and "open in new tab" all break, and a screen reader announces the wrong role.
            - link "Get started" [ref=e599] [cursor=pointer]:
              - /url: /docs/installation
            - generic [ref=e600]:
              - generic [ref=e601]:
                - tablist [ref=e603]:
                  - tab "TS" [selected] [ref=e604] [cursor=pointer]
                  - tab "JS" [ref=e605] [cursor=pointer]
                - generic [ref=e606]:
                  - button "Copy" [ref=e607] [cursor=pointer]
                  - status [ref=e608]
              - code [ref=e610]: import Link from 'next/link' <Button asChild> <Link href="/docs/installation">Get started</Link> </Button>
          - generic [ref=e611]:
            - heading "Overriding styles" [level=2] [ref=e612]
            - paragraph [ref=e613]: Every library selector is wrapped in :where(), which has specificity zero — so one flat class of your own wins, with no !important.
            - button "Beats the library" [ref=e615] [cursor=pointer]
            - generic [ref=e616]:
              - generic [ref=e617]:
                - tablist [ref=e619]:
                  - tab "TS" [selected] [ref=e620] [cursor=pointer]
                  - tab "JS" [ref=e621] [cursor=pointer]
                - generic [ref=e622]:
                  - button "Copy" [ref=e623] [cursor=pointer]
                  - status [ref=e624]
              - code [ref=e626]: "/* your stylesheet */ .my-cta { background: #db2777; border-radius: 999px; } <Button className=\"my-cta\">Beats the library</Button>"
          - separator [ref=e627]
          - generic [ref=e628]:
            - heading "Props" [level=2] [ref=e629]
            - paragraph [ref=e630]: Generated from the package's own type declarations, so this table cannot drift from the code.
            - table [ref=e632]:
              - caption [ref=e633]: Props for Button
              - rowgroup [ref=e634]:
                - row [ref=e635]:
                  - columnheader "Prop" [ref=e636]
                  - columnheader "Type" [ref=e637]
                  - columnheader "Default" [ref=e638]
                  - columnheader "Description" [ref=e639]
              - rowgroup [ref=e640]:
                - row [ref=e641]:
                  - cell [ref=e642]:
                    - code [ref=e643]: variant
                  - cell [ref=e644]:
                    - code [ref=e645]: "'solid' | 'outline' | 'ghost' | 'link'"
                  - cell "—" [ref=e646]
                  - cell "—" [ref=e647]
                - row [ref=e648]:
                  - cell [ref=e649]:
